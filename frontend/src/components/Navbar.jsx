    ...
    <div className='flex item-center justify-between py-5 font-medium px-[4vw] sm:px-[5vw] md:px-[7vw] lg:px-[9vw]'>
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='group'>
            ...
            {token && 
            <div className='group-hover:block hidden absolute dropdown-menu right-10 pt-4'>
              <div className='flex flex-col gap-2 w-36 py-3 px-5 relative z-10 bg-slate-100 text-gray-500 rounded'>
